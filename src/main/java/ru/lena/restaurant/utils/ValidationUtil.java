...
import ru.lena.restaurant.utils.exсeption.ErrorType;
import ru.lena.restaurant.utils.exсeption.IllegalRequestDataException;
import ru.lena.restaurant.utils.exсeption.NotFoundException;
import ru.lena.restaurant.utils.exсeption.VotingForbiddenException;
...
public class ValidationUtil {
    ...
    public static void checkVotingAllow() {
        LocalTime time = LocalTime.now();
        LocalTime deadLineTime = LocalTime.of(23, 0);
